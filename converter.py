...
def markdown_to_html_node(markdown) -> HTMLNode:
    ...
    for block in blocks:
        ...
        if block_type == Blocktype.HEADING:
            ...
            block_nodes.append(HTMLNode(tag='pre', children=[HTMLNode(tag='code', children=[code_child])]))
            ...
            li_nodes = [HTMLNode(tag='li', children=text_to_children(item)) for item in items]
...
def text_to_children(text) -> list[HTMLNode]:
    text_nodes = text_to_textnodes(text)  # You should already have this function
